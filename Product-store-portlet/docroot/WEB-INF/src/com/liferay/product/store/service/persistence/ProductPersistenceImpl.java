...
import com.liferay.product.store.NoSuchProductException;
import com.liferay.product.store.model.Product;
import com.liferay.product.store.model.impl.ProductImpl;
...
public class ProductPersistenceImpl extends BasePersistenceImpl<Product>
	...
	@Override
	public Product updateImpl(com.liferay.product.store.model.Product product)
		throws SystemException {
		product = toUnwrappedModel(product);
	...
	protected Product toUnwrappedModel(Product product) {
		...
		productImpl.setVideoLink(product.getVideoLink());
		productImpl.setProductLink(product.getProductLink());
		productImpl.setWikiLink(product.getWikiLink());
		productImpl.setCreatedBy(product.getCreatedBy());
		productImpl.setUpdatedBy(product.getUpdatedBy());
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.liferay.product.store.model.Product")));
