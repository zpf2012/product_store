...
/**
 * Provides the local service interface for Assess. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author zhangpengfei
 * @see AssessLocalServiceUtil
...
public interface AssessLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AssessLocalServiceUtil} to access the assess local service. Add custom service methods to {@link com.liferay.product.store.service.impl.AssessLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
