...
/**
 * Provides the local service interface for Apply. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author zhangpengfei
 * @see ApplyLocalServiceUtil
...
public interface ApplyLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link ApplyLocalServiceUtil} to access the apply local service. Add custom service methods to {@link com.liferay.product.store.service.impl.ApplyLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
