<div class="layout_test" id="main-content" role="main">
	...
	<div class="portlet-layout row-fluid">
		<div class="portlet-column portlet-column-first span9" id="column-6">
	...
	<div class="portlet-layout row-fluid">
		<div class="portlet-column portlet-column-only span12" id="column-8">
